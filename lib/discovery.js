...
function mixinDiscovery(MySQL, mysql) {
   ...
   */
  MySQL.prototype.querySchemas = function(options) {
   ...
   * @returns {string} The sql statement
   */
  MySQL.prototype.queryTables = function(options) {
    var sqlTables = null;
   ...
   * @returns {string} The sql statement
   */
   MySQL.prototype.queryViews = function(options) {
    var sqlViews = null;
    if (options.views) {
      var schema = options.owner || options.schema;
   ...
   * @returns {String} The sql statement
   */
  MySQL.prototype.queryColumns = function(schema, table) {
    var sql = null;
    if (schema) {
...
// #getPrimaryKeys(java.lang.String, java.lang.String, java.lang.String)
  MySQL.prototype.queryPrimaryKeys = function(schema, table) {
   ...
   * @returns {string}
   */
  MySQL.prototype.queryForeignKeys = function(schema, table) {
    var sql =
   ...
   * @returns {string}
   */
  MySQL.prototype.queryExportedForeignKeys = function(schema, table) {
